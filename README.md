# modified version of collectionbuilder-gh

to use with "compound objects", i.e. where a record has more than one image. 

For items, add main image to "filename" field as normal.
If the item has additional images, add the additional filename(s) to the "compound" column. 
